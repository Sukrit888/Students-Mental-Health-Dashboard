...
This dashboard provides a starting point for understanding the complex relationship between lifestyle factors and mental health in a student population. Feel free to use the filters on the
