...
def load_data():
    ...
    try:
        ...
        st.error("Error: The 'MentalHealthSurvey.csv' file was not found. Please make sure it's in the same directory.")
        return None
...
st.write("This interactive dashboard visualizes key factors influencing student mental health based on your survey data.")
st.markdown("---")
